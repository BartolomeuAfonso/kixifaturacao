...
@else
        ...
        <table class="table table-sm">
            ...
            <tbody>
                <tr class="smal m-0 p-0">
                    ...
                    <td>
                        <{{ number_format(($factura[0]->ccoTotal - $factura[0]->ccoIVA) / 601.24, 2, '.', ' ') }}-->
                    </td>
                </tr>
                <tr class="smal m-0 p-0">
                    <td>Total Imposto</td>
                    ...
                    <td>
                        {{ number_format($factura[0]->ccoIVA / 601.24, 2, '.', ' ') }}
                    </td>
                </tr>
                <tr class="m-0 p-0">
                    <th>TOTAL A PAGAR</th>
                    ...
                    <td>
                        {{ number_format($factura[0]->ccoTotal / 601.24, 2, '.', ' ') }}
    ...
    <footer class="fixed-bottom p-2 small" style="height: 85px">
        <div>
            <span class="text-size-8 ml-4">mhe8-Processado por programa validado n.° 301/AGT/2021 © Kixipedidos 6.1 |
